...
class __Mustache_e2ab8e96b5858845097f53404f64e204 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                ...
                'element' => array($this, 'blockFd84623f02c47fae361218963a543179'),
            ));
...
';
    ...
    public function blockFd84623f02c47fae361218963a543179($context)
    {
        $indent = $buffer = '';
